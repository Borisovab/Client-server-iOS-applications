...
class PushAnimator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let sourseFrame = CGRect(x: -conteinerFrame.height, y: 0, width: conteinerFrame.height, height: conteinerFrame.width)
        ...
        destinationVC.view.frame = CGRect(x: conteinerFrame.width, y: 0, width: conteinerFrame.width, height: conteinerFrame.height)
