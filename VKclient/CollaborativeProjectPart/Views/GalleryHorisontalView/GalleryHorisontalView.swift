...
@IBDesignable class GalleryHorisontalView: UIView {
    ...
    private func loadFromXib() -> UIView {
        ...
        let xib = UINib(nibName: "GalleryHorisontalView", bundle: bundle)
    ...
    private func setup() {
        ...
        let recognizer = UIPanGestureRecognizer(target: self, action: #selector(onTap(_ :)))
        self.addGestureRecognizer(recognizer)


        mainImageView.backgroundColor = UIColor.systemMint
        ...
        customPageView.frame = CGRect(x: 1, y: 1, width: 150, height: 150)
